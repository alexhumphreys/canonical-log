...
*(Nested work units were defined 2026-07-02 — inner shadows outer, `parent_work_unit_id` + `work_unit_depth`, one line per unit; see the gotchas entry and `NestedWorkUnitTest`.)*
