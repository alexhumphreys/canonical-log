...
- `canonical-log-core` — accumulator, `WorkUnit`, `WorkUnitAdapter`, `Outcome`, `CanonicalLogContext`, the `ThreadContextElement` bridge, the `CanonicalLogMdc` MDC mirror (see the gotchas entry). Framework-agnostic.
